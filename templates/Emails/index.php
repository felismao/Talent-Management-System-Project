            ...
            <div class="card mb-4">
                ...
                <div class="table-responsive p-0">
                    <table class="table align-items-center mb-0">
                        ...
                        <thead>
                        <tr>
                            <th class="text-uppercase text-secondary text-lg font-weight-bolder opacity-7 "><?= $this->Paginator->sort('name') ?></th>
                            <th class="text-uppercase text-secondary text-lg font-weight-bolder opacity-7 ps-2"><?= $this->Paginator->sort('email','Email Address') ?></th>
                            <th class="text-uppercase text-secondary text-lg font-weight-bolder opacity-7 ps-2"><?= $this->Paginator->sort('contact','Contact Number') ?></th>
                            <th class="text-uppercase text-secondary text-lg font-weight-bolder opacity-7 ps-2"><?= $this->Paginator->sort('purpose','Type') ?></th>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <span class="text-secondary text-s"><?= h($email->name) ?></span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <span class="text-secondary text-s"><?= h($email->email) ?></span>
                                </td>

                                <td>
                                    <span class="text-secondary text-s"><?= $email->contact ?></span>
                                </td>
                                <td>
                                    <span class="text-secondary text-s"><?= h($email->purpose) ?></span>
                                </td>
