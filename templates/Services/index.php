                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <span class="text-secondary text-s"><?= h($service->title) ?></span>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-secondary font-weight-bold text-xs">
                                    <div class="grid">
                                        <!--<div><?= $this->Html->link(__('View'), ['action' => 'view', $service->id]) ?></div>-->
                                        <div><?= $this->Html->link(__('Edit'), ['action' => 'edit', $service->id],array('class' => 'text-sm')) ?></div>
                                        <div><?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $service->id], array('confirm' => __('Are you sure you want to delete {0}?', $service->id),'class' => 'text-sm')) ?></div>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach; ?>
