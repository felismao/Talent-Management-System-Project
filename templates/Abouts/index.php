                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <span class="text-secondary text-s"><?= h($about->title) ?></span>
                                        </div>
                                    </div>
                                </td>
                                <td class="text-secondary font-weight-bold text-xs">
                                    <div class="grid">
                                        <!--<div><?= $this->Html->link(__('View'), ['action' => 'view', $about->id]) ?></div>-->
                                        <div><?= $this->Html->link(__('Edit'), ['action' => 'edit', $about->id],array('class' => 'text-sm')) ?></div>
                                        <div><?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $about->id], array('confirm' => __('Are you sure you want to delete {0}?', $about->id),'class' => 'text-sm')) ?></div>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach; ?>
