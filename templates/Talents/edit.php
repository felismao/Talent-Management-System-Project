        ...
        <div class="container">
                        <div class="container" style="padding: 20%">
                            ...
                            <div class="colums">
                                ...
                                <div class="question">
                                    <label>Do you have any additional media?</label>
                                    <div class="question-answer">
                                        <div>
                                            <!-- if there is media data, set the radio button to checked -->
                                            <?php if ($talent->mediaone == null or $talent->mediatwo == null or $talent->mediathree == null) { ?>
                                                <!-- if the radio button is clicked, call the javascript function -->
                                                <input type="radio" value="none" onclick="javascript:yesnoReelCheck();" name="yesnoReel" id="radio_7" />
                                            <?php } else { ?>
                                                <!-- set the radio button as checked -->
                                                <input type="radio" value="none" onclick="javascript:yesnoReelCheck();" name="yesnoReel" id="radio_7" checked/>
                                            <?php }?>
                                            <label for="radio_7" class="radio"><span>Yes</span></label>
                                        </div>
                                        <div>
                                            <!-- if the no radio button is clicked, call the javascript function to hide the input fields -->
                                            ...
                                            <!-- if the yes radio button is checked, display the edit media functions -->
                                            <div id="ifReelYes" style="display: none;">
                                                <label>Upload Additional Media</label>
                                                <!-- media 1 file input field -->
                                                <?php echo $this->Form->control('change_filename1', ['type'=>'file', 'label'=>'']); ?>
                                                ...
                                                <!-- media 2 file input field -->
                                                <?php echo $this->Form->control('change_filename2', ['type'=>'file', 'label'=>'']); ?>
                                                <?php if ($talent->mediatwo != null) { ?>
                                                    <?= $this->Html->image($talent->mediatwo,['style'=>'width:75px'])?>
                                                <?php } else { ?><?php echo $this->Html->image('image-not-found.png', array('alt' => 'error', 'style'=>'width:75px'));?><?php }?>

                                                <!-- media 3 file input field -->
                                                <?php echo $this->Form->control('change_filename3', ['type'=>'file', 'label'=>'']); ?>
                            ...
                            <div class="question">
                                ...
                                <div class="question-answer">
                                    <div>
                                        <!-- if there is tattoo data, set the radio button to checked -->
                                        <?php if ($talent->tattoos == null) { ?>
                                            <!-- set the radio button as not checked -->
                                        <input type="radio" value="none" onclick="javascript:yesnoTattooCheck();" name="yesno" id="radio_15" />
                                        <?php } else { ?>
                                            <!-- set the radio button as checked -->
                                            <input type="radio" value="none" onclick="javascript:yesnoTattooCheck();" name="yesno" id="radio_15" checked/>
                                        <?php }?>
                                    ...
                                    <div>
                                        ...
                                        <!-- if the radio button is checked, display the edit tattoo functions -->
                            ...
                            <div class="question">
                                ...
                                <div class="question-answer">
                                    <div>
                                        <!-- if there is piercing data, set the radio button to checked -->
                                        ...
                                        <?php } else { ?>
                                            <!-- set the radio button as checked -->
                                            <input type="radio" value="none" onclick="javascript:yesnoPiercingCheck();" name="yesnoPiercing" id="radio_13" checked/>
                                        <?php }?>
                                    ...
                                    <div>
                                        ...
                                        <div id="ifPiercingYes" style="display: none;">
                                            <!-- if the radio button is checked, display the edit piercing functions -->
                                            <label>If yes, where abouts: </label>
                            ...
                            <div class="question">
                                ...
                                <div class="question-answer">
                                    <div>
                                        <!-- if there is body mod data, set the radio button to checked -->
                                        <?php if ($talent->bodymod == null) { ?>
                                            <!-- set the radio button as not checked -->
                                        <input type="radio" value="none" onclick="javascript:yesnoBodyCheck();" name="yesnoBody" id="radio_11" />
                                        <?php } else { ?>
                                            <!-- set the radio button as checked -->
                                            <input type="radio" value="none" onload="javascript:yesBodyCheck();" onclick="javascript:yesnoBodyCheck();" name="yesnoBody" id="radio_11" checked/>
                                        <?php }?>
                                    ...
                                    <div>
                                        ...
                                        <div id="ifBodyYes" style="display: none;">
                                            <!-- if the radio button is checked, display the edit body mod functions -->
                                            <label>If yes, where abouts: </label>
                            ...
                            <div class="question">
                                ...
                                <div class="question-answer">
                                    <div>
                                        <!-- if there is nudity data, set the radio button to checked -->
                                        <?php if ($talent->nudity == null) { ?>
                                            <!-- set the radio button as not checked -->
                                        <input type="radio" value="none" onclick="javascript:yesnoNudeCheck();" name="yesnoNude" id="radio_9"/>
                                        <?php } else { ?>
                                            <!-- set the radio button as checked -->
                                        <input type="radio" value="none" onclick="javascript:yesnoNudeCheck();" name="yesnoNude" id="radio_9" checked/>
                                        <?php }?>
                                    ...
                                    <div>
                                        ...
                                        <div id="ifNudeYes" style="display: none;">
                                            <!-- if the radio button is checked, display the edit nudity data functions -->
